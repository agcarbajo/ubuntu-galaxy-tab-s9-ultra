...
| `kernel/patches/qcomtee-use-tzmem-pool.patch` | Extensión propia sobre QCOMTEE de Linux 7.2-rc3 para respaldar objetos de memoria mayores de 4 MiB con `qcom_tzmem`; necesaria para entregar la TA firmada `dualfp` mediante `loadFromRegion` | — (derivado del kernel fijado arriba) |
