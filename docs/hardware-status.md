...
| Huella: infraestructura EL721/UDFPS | ❌ | 🟡 | supuesto | Preparados el control restringido de alimentación/reset sin acceso a datos, QTEE, el modo óptico del panel y la exclusión regional del táctil. Tras provocar un reinicio temprano, la pila queda inerte en builds normales y sólo se activa con `ENABLE_FINGERPRINT_EXPERIMENTAL=1` para aislar capas; detalles en [fingerprint-reader.md](fingerprint-reader.md) |
