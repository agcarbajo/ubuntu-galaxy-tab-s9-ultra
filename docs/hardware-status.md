...
| Tab Companion | — | 🟡 | medido | Paquete `ubuntu-gts9u-companion` 0.2.0 instalado. Su servicio D-Bus de usuario entrega `docked`, `tip-right`, carga discreta, teclado presente y Bluetooth disponible; la UI consumió esos datos en una captura Xvfb inspeccionada en la tablet. Falta confirmación visual en la sesión GNOME real y ejecutar acciones |
