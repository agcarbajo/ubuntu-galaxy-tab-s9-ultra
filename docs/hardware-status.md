...
| S Pen: emparejamiento BLE | ❌ | 🟡 | confirmado | El comando Wacom 0xea abre el anuncio al acoplarlo. El servicio aceptó la autorización iniciada por el lápiz y confirmó `Bonded`, `Paired`, `Trusted` sin interacción. Tras un arranque completo conservó el vínculo y 100 %. Insertado usa siempre Mode `0x10`: activar el sensor raw del puntero durante la carga cortaba prematuramente el enlace; tras corregirlo permaneció conectado y cargando más de 20 s. Insertarlo sigue siendo el despertar fiable |
